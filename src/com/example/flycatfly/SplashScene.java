...
public class SplashScene extends Scene{
	...
	public SplashScene(){
		...
		Text title1 = new Text(0, 0, activity.mFont,activity.getString(R.string.splash_string1), activity.getVertexBufferObjectManager());
		Text title2 = new Text(0, 0, activity.mFont, activity.getString(R.string.splash_string2), activity.getVertexBufferObjectManager());
